...
const Contact = () => {
  ...
  return ( 
    <div name='contact' className='w-full h-screen flex  flex-col justify-center bg-[#0a192f] border-t-[1px] border-t-[#7da0c4] text-gray-200'>
       <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
       <div className='mt-10'>
       <p className='text-4xl font-bold sm:text-center inline border-b-4 border-[#f36e8f]'>Contact me</p>
